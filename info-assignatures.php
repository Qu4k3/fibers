    ...
    <div class="content">
      <div class="content-container">
        <div class="row">
          <div class="col s12">
            <h5 class="page-title">
              <span>Descripció detallada de cada assignatura</span>
            </h5>
          </div>
        </div>
        <div class="row">
          <div class="col s12">
            <h6>Fundaments Matematics (FM)</h6>
            <p><span class="text-darken">Dificultat:</span> &nbsp; 8/10</p>
            <p><span class="text-darken">Enfocat:</span> <span class="new badge blue" data-badge-caption="Software"></span></p>
            <p><span class="text-darken">Descripció:</span> &nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit,
        ...
        <div class="row">
          <div class="col s12">
            <h6>Fundaments Matematics (FM)</h6>
            <p><span class="text-darken">Dificultat:</span> &nbsp; 8/10</p>
            <p><span class="text-darken">Enfocat:</span> <span class="new badge green" data-badge-caption="Hardware"></span></p>
            <p><span class="text-darken">Descripció:</span> &nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
               Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
               ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
        ...
        <div class="row">
          <div class="col s12">
            <h6>Fundaments Matematics (FM)</h6>
            <p><span class="text-darken">Dificultat:</span> &nbsp; 8/10</p>
            <p><span class="text-darken">Enfocat:</span> <span class="new badge indigo darken-1" data-badge-caption="Programador"></span></p>
            <p><span class="text-darken">Descripció:</span> &nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
               Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
               ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
